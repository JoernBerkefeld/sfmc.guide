...
layout: page
title: "Empty"
description: "Tests whether a value is missing or blank. Covers which inputs count as empty, and the exact literals True and False that the function renders."
...
- [Official reference](https://developer.salesforce.com/docs/marketing/marketing-cloud-ampscript/references/mc-ampscript-utilities/mc-ampscript-reference-utilities-empty.html)
- [ampscript.guide](https://ampscript.guide/empty/)
